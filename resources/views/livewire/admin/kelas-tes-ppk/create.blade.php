        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Nama Gelombang Tes</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="tanggal" type="datetime-local" placeholder="Tanggal Assessment" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" value="{{ old('tanggal') }}" required autocomplete="tanggal" autofocus wire:model="wRTanggal">
                    @error('wRTanggal') <span class="text-danger error">{{ $message }}</span>@enderror
                </div>
                {{-- <div class="form-group">
                            <label>Nilai Ambang Batas</label>
                            <input id="ambang_batas" placeholder="Nilai Ambang Batas" type="number" class="form-control @error('ambang_batas') is-invalid @enderror" name="ambang_batas" value="{{ old('ambang_batas') }}" required autocomplete="waktu_pengerjaan" wire:model ="wrAmbangBatas">
                @error('wrAmbangBatas') <span class="text-danger error">{{ $message }}</span>@enderror
            </div> --}}
            <div class="form-group">
